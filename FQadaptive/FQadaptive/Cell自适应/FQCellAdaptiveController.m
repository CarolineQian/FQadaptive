...
#import "FQCellAdaptiveController.h"
#import "textAdaptiveCell.h"

@interface FQCellAdaptiveController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation FQCellAdaptiveController
...
- (void)viewDidLoad
{
    ...
    for (int i = 0; i < _dataArray.count; i++)
    {
        ...
        CGSize size = [_dataArray[i] boundingRectWithSize:CGSizeMake(ScreenWidth - 15 * 2, 1000) options:NSStringDrawingUsesLineFragmentOrigin attributes:dic context:nil].size;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    textAdaptiveCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell)
        cell = [[[NSBundle mainBundle] loadNibNamed:@"textAdaptiveCell" owner:self options:nil] lastObject];
    //cell内容
